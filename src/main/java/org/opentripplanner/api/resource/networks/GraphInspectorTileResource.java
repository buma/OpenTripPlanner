...
public class GraphInspectorTileResource {
    ...
    @Context OTPServerWithNetworks otpServer;
    ...
    public InspectorLayersList getLayers() {
        ...
        org.opentripplanner.streets.Router router = otpServer.getRouter(routerId);
        InspectorLayersList layersList = InspectorLayersList.fromNetworksTileRenderer(router.tileRendererManager.getRenderers());
        return layersList;
    }
