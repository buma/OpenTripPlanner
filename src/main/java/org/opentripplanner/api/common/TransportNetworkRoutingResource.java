...
/**
 * Copy of RoutingResource for TransportNetworks
 *
 ...
 * @author abyrd
 */
public class TransportNetworkRoutingResource {

    private static final Logger LOG = LoggerFactory
        .getLogger(TransportNetworkRoutingResource.class);
    /**
     ...
     */
    @Context
    protected OTPServerWithNetworks otpServer;
    ...
    protected TransportNetworkRequest buildRequest() throws ParameterException {
...

        {
            ...
            TimeZone tz;
            tz = router.transportNetwork.getTimeZone();
