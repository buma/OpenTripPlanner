...
otp.locale.Chinese = {
    ...
    time: {
        format         : "MM-DD-YYYY, h:mma", //moment.js
        date_format    : "MM-DD-YYYY", //momentjs must be same as date_picker format which is by default: yy-mm-dd and changed to mm-dd-yy
